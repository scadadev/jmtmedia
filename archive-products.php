...
<?php $author_id = get_field( 'author_archive',$fake_page_id ); ?> 
<?php 
                                ...
                                <a href="<?php echo get_author_posts_url($author_id); ?>">
                                        <?php
                                            if (!empty($author_avatar_html)) {
                                                ...
                                                if ($BORN_FRAMEWORK->Options->Get('default_user_icon')) {
                                                    echo born_acf_image($BORN_FRAMEWORK->Options->Get('default_user_icon')['id'], 'icons-large-160', true);
                                                }
                                            }
                                        ?>
                                </a>
