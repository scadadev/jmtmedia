                    ...
                    <div class="offer">
                        ...
                        <div class="card-wrapper">
                            ...
                            <div class="card is-large">
                                ...
                                <div class="data">
                                    <a href="<?php echo get_permalink($prod->ID);?>" class="name"><?php echo get_the_title($prod->ID);?></a>
                                ...
                                <div class="cta"><a href="<?php echo get_field('main_link',$prod->ID);?>"><?php echo $BORN_FRAMEWORK->Options->Get('play' . $lang_code);?></a></div>
                            </div>
    ...
    <div class="born-container is-wide">
        ...
        <div class="games-grid">
            ...
            <div class="game-card">
                ...
                <div class="cta">
                    <a href="<?php echo get_permalink();?>" class="button"><?php echo $BORN_FRAMEWORK->Options->Get('read_more' . $lang_code); ?></a>
                </div>
            </div>
        ...
        <div class="content">
            <div class="main">
                ...
                <div class="author">
                    ...
                    <span><?php echo $BORN_FRAMEWORK->Options->Get('review_by' . $lang_code);?><span><?php echo get_the_author_meta('first_name');?> <?php echo get_the_author_meta('last_name');?></span></span>
                </div>
                        ...
                        <div class="items-grid">
                            ...
                            <div class="item">
                                ...
                                <div class="data">
                                    ...
                                    <div class="row">
                                        <a href="<?php echo get_permalink($single_featured->ID);?>" class="name"><?php echo get_the_title(get_permalink($single_featured->ID));?></a>
                                    </div>
                                    <div class="row">
                                ...
                                <div class="details">
                                    ...
                                    <div class="cta">
                                        <a href="<?php echo get_permalink($single_featured->ID);?>" class="button"><?php echo $BORN_FRAMEWORK->Options->Get('go_to_profile' . $lang_code);?></a>
                                    </div>
                                </div>
                                <div class="cta">
                                    <a href="<?php echo get_field('main_link',$single_featured->ID);?>" class="button"><?php echo $BORN_FRAMEWORK->Options->Get('play' . $lang_code);?></a>
                                </div>
                            </div>
