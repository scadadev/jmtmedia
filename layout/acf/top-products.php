            ...
            <div class="title-meta">
                <div class="title-meta__wrap">
                    ...
                    <div class="title-meta__item"><?php
                        try {
                            $reader = new Reader(PARENT_PATH . '/geo/GeoLite2-Country.mmdb');
                            ...
                            if( !empty($record->country->name) ) {
                                ...
                                echo $BORN_FRAMEWORK->Options->Get('page_meta_country_'.$lang_code) .' '. $record->country->name;
                            }
                        }
                        catch ( \Exception $e ) {
                    ...
                    <div class="title-meta__item">
                        ...
                        <?php echo $BORN_FRAMEWORK->Options->Get('page_meta_country_'.$lang_code); ?>
                    </div>
                </div>
            </div>
        <?php endif; ?>
        ...
        <div class="born-container is-wide">
            <div class="content">
                ...
                <div class="cta">
                    ...
                    <a href="<?php echo get_permalink($product->ID);?>" class="text"><?php echo $BORN_FRAMEWORK->Options->Get('read_reviews'.$lang_code);?></a>
                </div>
            </div>
        </div>
    </div>
